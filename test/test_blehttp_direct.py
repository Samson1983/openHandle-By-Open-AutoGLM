"""Direct test script for BLE HTTP interfaces."""

# Directly import from bleHttp module files
from phone_agent.bleHttp.connection import connect, get_state, get_app_list
from phone_agent.bleHttp.device import tap, swipe, long_press, back, home, recent_apps
from phone_agent.bleHttp.input import type_text, copy, paste
...
try:
    connect('http://192.168.0.202:9123')
    print('   connect: successful')
except Exception as e:
    print(f'   connect: failed - {e}')

# try:
#     state = get_state('http://192.168.0.202:9123')
#     print('   get_state: successful')
# except Exception as e:
#     print(f'   get_state: failed - {e}')

# try:
#     app_list = get_app_list('http://192.168.0.202:9123')
...
# try:
#     tap('http://192.168.0.202:9123', 100, 100)
#     print('   tap: successful')
# except Exception as e:
#     print(f'   tap: failed - {e}')

# try:
#     swipe('http://192.168.0.202:9123', 100, 100, 200, 200, 500)  # Should be limited to 300ms
#     print('   swipe: successful')
# except Exception as e:
#     print(f'   swipe: failed - {e}')

# try:
#     long_press('http://192.168.0.202:9123', 100, 100, 500)
#     print('   long_press: successful')
# except Exception as e:
#     print(f'   long_press: failed - {e}')

# try:
#     back('http://192.168.0.202:9123')
#     print('   back: successful')
# except Exception as e:
#     print(f'   back: failed - {e}')

# try:
#     home('http://192.168.0.202:9123')
#     print('   home: successful')
# except Exception as e:
#     print(f'   home: failed - {e}')

# try:
#     recent_apps('http://192.168.0.202:9123')
...
# try:
#     copy('http://192.168.0.202:9123')
#     print('   copy: successful')
# except Exception as e:
#     print(f'   copy: failed - {e}')

# try:
#     paste('http://192.168.0.202:9123')
...
# try:
#     screenshot = get_screenshot('http://192.168.0.202:9123')
